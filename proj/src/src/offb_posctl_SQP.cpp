...
{
    logfile << controlstatearray.stateXarray[0] << "," << controlstatearray.stateZarray[0] << "," <<  controlstatearray.thetaarray[0] << "," << \
    controlstatearray.thrustarray[0] << "," << cur_time << "," << targeterror_msg.x << "," << targeterror_msg.z << "," << time_cost << "," << controlstatearray.error << std::endl;
}